...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col max-md:px-2 items-center justify-center flex-1">
        <div className="mt-[80px] flex items-center justify-center gap-2 text-white">
          <TrendingUpIcon className="size-5" />
          Professional Electrical Knowledge Platform
        </div>

        <h1 className="text-center text-white font-urbanist text-[42px]/13 md:text-6xl/20 font-bold max-w-2xl">
          Smart Electrical <span className="text-primary">Solutions</span>
        </h1>

        <p className="text-center text-gray-300 max-w-lg mt-4">
          Learn house wiring, DB board setup, load calculation, safety
          inspection and government regulations — powered by AI assistant.
        </p>
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          ...
          <button className="border border-gray-600 text-white px-4 py-2.5 rounded-lg hover:bg-gray-900">
            Learn More
            <ArrowDownRightIcon className="ml-1 size-5 inline-flex" />
          </button>
        </div>
